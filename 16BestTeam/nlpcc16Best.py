...
def loadResAndanswerAllQ(pathInput, pathOutput, pathDict, pathQt, pathVD, encode='utf16', qIDstart=1):
...
if len(sys.argv) == 7:
    ...
    loadResAndanswerAllQ(pathInput, pathOutput, pathDict, pathQt, pathVD, 'utf16', qIDstart)
